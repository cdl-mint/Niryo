...
robot_ip_address = "192.168.0.103"
workspace_name = "ws_conveyor"
...
observation_pose = PoseObject(
    x=0.0, y=-0.134, z=0.355,
    roll=0.0, pitch=1.57, yaw=-1.724,
)

center_conditioning_pose = PoseObject(
    x=0.265, y=0.0, z=0.133,
    roll=-2.6, pitch=1.57, yaw=-2.588,
)
